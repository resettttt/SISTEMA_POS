...
<head>
    ...
    <title>Dashboard Trabajador - Sistema POS</title>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-secondary">
                    <div class="card-body">
                        ...
                        <h3>Trabajador</h3>
                        <p class="card-text">Con permisos limitados</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="?controller=product&action=index" class="btn btn-outline-primary">Ver Productos</a>
                            <a href="?controller=sales&action=index" class="btn btn-outline-info">Ver Ventas</a>
                        </div>
                        <div class="mt-3">
                            <div class="alert alert-warning">
                                <small>Nota: Como trabajador, tienes permisos limitados. No puedes crear/editar usuarios ni eliminar clientes.</small>
                            </div>
                        </div>
                    </div>
                </div>
